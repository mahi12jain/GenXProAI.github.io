        ...
        <section id="about" className="py-20 px-4 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="text-3xl md:text-5xl font-bold text-[#050040] mb-6 leading-tight">
                        About GenX Pro AI: Leading Enterprise AI Solutions Provider for Business Transformation
                    </h1>
                    <p className="text-lg md:text-xl text-slate-600 max-w-4xl mx-auto mb-4">
                ...
                <div className="bg-indigo-50/50 p-8 rounded-2xl border border-indigo-100 mb-16">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#050040] mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-3xl md:text-4xl font-bold text-[#050040] mb-6">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-[#050040] mb-4">
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-8 rounded-xl border border-slate-200 hover:border-blue-500 transition-all duration-300 hover:shadow-lg group">
                            <div className="flex items-start space-x-4">
                                <div className="w-14 h-14 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0 group-hover:bg-blue-100 transition-colors">
                                    <span className="text-3xl">🎯</span>
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-[#050040] mb-3">Our Mission: Democratizing Enterprise AI</h3>
                        ...
                        <div className="bg-white p-8 rounded-xl border border-slate-200 hover:border-indigo-500 transition-all duration-300 hover:shadow-lg group">
                            <div className="flex items-start space-x-4">
                                <div className="w-14 h-14 rounded-lg bg-indigo-50 flex items-center justify-center flex-shrink-0 group-hover:bg-indigo-100 transition-colors">
                                    <span className="text-3xl">💡</span>
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-[#050040] mb-3">Strategic Approach: Results-Driven Methodology</h3>
                                    <p className="text-slate-700 leading-relaxed">
                        ...
                        <div className="bg-white p-8 rounded-xl border border-slate-200 hover:border-violet-500 transition-all duration-300 hover:shadow-lg group">
                            <div className="flex items-start space-x-4">
                                <div className="w-14 h-14 rounded-lg bg-violet-50 flex items-center justify-center flex-shrink-0 group-hover:bg-violet-100 transition-colors">
                                    <span className="text-3xl">🤝</span>
                                </div>
                                <div>
                                    <h3 className="text-xl font-bold text-[#050040] mb-3">Client Commitment: Long-Term Partnership Model</h3>
                                    <p className="text-slate-700 leading-relaxed">
                ...
                <div className="mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#050040] text-center mb-12">
                        Why Global Enterprises Choose GenX Pro AI
                    </h2>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-blue-400 transition-all duration-300 hover:shadow-lg">
                            <h3 className="text-xl font-bold text-[#050040] mb-3">🏆 Industry Recognition</h3>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-indigo-400 transition-all duration-300 hover:shadow-lg">
                            <h3 className="text-xl font-bold text-[#050040] mb-3">🔒 Enterprise Security</h3>
                            <p className="text-slate-700">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-violet-400 transition-all duration-300 hover:shadow-lg">
                            <h3 className="text-xl font-bold text-[#050040] mb-3">🌍 Global Delivery Model</h3>
                            <p className="text-slate-700">
                ...
                {/* FAQ Section for AGO */}
                <div className="mb-16">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#050040] mb-8 text-center">
                        Frequently Asked Questions About GenX Pro AI
                    </h2>
                    <div className="space-y-6 max-w-4xl mx-auto">
                        <div className="bg-white p-6 rounded-xl border border-slate-200 hover:border-blue-400 transition-all duration-300">
                            <h3 className="text-xl font-bold text-[#050040] mb-3">
